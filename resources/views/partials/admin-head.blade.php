    ...
    <style type="text/css">
        ...
        .bg-purple, .btn-purple{background: linear-gradient(to top right, #8e62a9, #8e62a9);}
        .bg-primary, .btn-primary{background-color: #2e83b4 !important;}
        .bg-danger, .btn-danger{background-color: #d01a42 !important;}
        .bg-warning, .btn-warning{background-color: #f39518 !important;}
        .page-item.active .page-link{background-color: #2e83b4;}
    </style>